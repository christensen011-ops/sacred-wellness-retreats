...
const pageMeta = {
  home: {
    ...
    description: "Transformational all-inclusive wellness retreats in Oaxaca, Tulum, and Bali. Guided meditation, mountain hikes, ceremonial experiences, and delicious meals. Limited to 7 guests.",
  },
  retreats: {
    title: "Retreat Dates & Locations | Sacred Wellness Retreats",
    description: "Upcoming wellness retreats: Magical Oaxaca & Sierra Sur (Aug 3–9), Bali Mountain Sanctuary (Sep 5–9), Tulum Jungle Reset (Oct 22–26). Limited to 7 guests.",
  },
  "retreat-detail": {
...
const retreats = [
  {
    ...
    itinerary: [
      ...
      { day: "Aug 4 — Day 2", title: "Oaxaca City Exploration", content: "Morning meditation, guided exploration of Oaxaca City — colonial architecture, local markets, and the rich culture of the Zapotec heartland. Group dinner, evening meditation." },
      { day: "Aug 5 — Day 3", title: "Into the Mountains", content: "Morning meditation, private van departs for San José del Pacífico. Settle into your mountain cabanas at 8,200 feet. Afternoon guided meditation with panoramic Sierra Sur views. Welcome mountain dinner." },
      { day: "Aug 6 — Day 4", title: "Stillness & The Sierra Sur", content: "Dawn meditation, guided hike through ancient mountain trails. Free contemplative time in the afternoon with your guide holding space. Evening sharing circle." },
      { day: "Aug 7 — Day 5", title: "Deep Practice", content: "Morning meditation class, personal reflection time, guided afternoon session. Communal dinner under the mountain sky." },
      { day: "Aug 8 — Day 6", title: "Descent & Integration", content: "Final mountain morning meditation and closing ceremony. Private van returns to Oaxaca City. Evening farewell dinner in the city." },
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          <a href="https://whatsapp.com/channel/0029Vb8Bl5L23n3iiykLfd0p" target="_blank" rel="noopener noreferrer" style={{
    ...
    <div style={{ position: "relative", height: "100vh", minHeight: 600, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "0 24px", paddingTop: 80 }}>
        ...
        <p className="fade-in delay-2" style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "1rem", color: "rgba(255,255,255,0.78)", lineHeight: 1.7, maxWidth: 480, marginBottom: 44 }}>
          Curated wellness retreats designed for deep rest, cultural immersion, and genuine inner transformation. Intentionally small. All-inclusive.
        </p>
...
function Pillars() {
  const items = [
    { icon: "◎", title: "Nervous System Reset", desc: "Deep rest in nature, guided meditation, and stillness practices that restore your baseline and bring you back to yourself." },
    { icon: "◇", title: "Cultural Immersion", desc: "Authentic local experiences — food, people, landscapes — that expand perspective and awaken a sense of aliveness." },
    { icon: "○", title: "Guided Meditation", desc: "Daily practice led by a certified Ishayas' Ascension teacher. Accessible for all levels, deeply effective for all who show up." },
    { icon: "△", title: "Nature & Restoration", desc: "Mountains, forests, open skies — environments that do the work simply by being what they are. Rest is transformation here." },
  ];
  return (
    <section style={{ background: theme.cream, padding: "80px 24px" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 className="section-title">Four Pillars of Transformation</h2>
        </div>
...
function RetreatCard({ retreat }) {
  ...
  if (retreat.comingSoon) {
    return (
      <div style={{ background: theme.white, overflow: "hidden", opacity: 0.85, position: "relative" }}>
        <div style={{ height: 220, backgroundImage: `url(${retreat.image})`, backgroundSize: "cover", backgroundPosition: "center", position: "relative" }}>
          ...
          <div style={{ position: "absolute", top: 16, left: 16, background: theme.bark, color: theme.cream, fontFamily: "'DM Sans',sans-serif", fontSize: "0.7rem", letterSpacing: "0.15em", textTransform: "uppercase", padding: "5px 12px" }}>
            Coming 2027
          </div>
          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.8rem", color: theme.white, fontStyle: "italic", fontWeight: 300, textAlign: "center", padding: "0 24px" }}>{retreat.name}</span>
          </div>
        </div>
  ...
  return (
    <div style={{ background: theme.white, overflow: "hidden", transition: "transform 0.3s", cursor: "pointer" }}
      ...
      <div style={{ padding: "28px 28px 32px" }}>
        ...
        {retreat.couplePrice && (
          <p style={{ fontSize: "0.78rem", color: theme.stone, marginBottom: 4 }}>Couples: <span style={{ color: theme.olive, fontWeight: 500 }}>{retreat.couplePrice}</span> <span style={{ color: theme.stone }}>— save $800</span></p>
        )}
  ...
  return (
    <>
      <div style={{ background: theme.oliveDark, padding: "140px 24px 80px", textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.95rem", maxWidth: 420, margin: "0 auto" }}>Each retreat is intentionally small — never more than 7 guests — for a deeply personal experience.</p>
      </div>
      <section style={{ background: theme.cream, padding: "80px 24px" }}>
        <div className="container">
          ...
          {retreat.id === 4 && (
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16, marginBottom: 16 }}>
                <div style={{ height: 280, backgroundImage: `url(https://res.cloudinary.com/dyuinj9pz/image/upload/v1782336873/IMG_5900_p1f2im.jpg)`, backgroundSize: "cover", backgroundPosition: "center" }} />
          ...
          <div>
            ...
            {retreat.id === 4 && (
              <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 28 }}>
                <div style={{ background: theme.sand, padding: "16px 20px", borderLeft: `3px solid ${theme.olive}`, flex: "1 1 200px" }}>
                  <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.7rem", letterSpacing: "0.15em", textTransform: "uppercase", color: theme.stone, marginBottom: 4 }}>Solo</p>
                ...
                <div style={{ background: theme.sand, padding: "16px 20px", borderLeft: `3px solid ${theme.accent}`, flex: "1 1 200px" }}>
                ...
                <div style={{ background: theme.sand, padding: "16px 20px", borderLeft: `3px solid ${theme.bark}`, flex: "1 1 200px" }}>
                  ...
                  <p style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.5rem", color: theme.bark }}>{retreat.deposit}</p>
                </div>
              </div>
            )}
          ...
          {retreat.travelInfo && (
            <>
              ...
              <div>
                ...
                <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "2rem", fontWeight: 400, marginBottom: 20, color: theme.charcoal }}>{retreat.travelInfo.title}</h2>
                <div style={{ background: theme.sand, padding: "28px", borderLeft: `3px solid ${theme.olive}` }}>
                  <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 14 }}>
                    {retreat.travelInfo.items.map((item, i) => (
                      <li key={i} style={{ display: "flex", gap: 12, fontSize: "0.9rem", color: theme.charcoal, lineHeight: 1.6 }}>
                        <span style={{ color: theme.olive, flexShrink: 0, marginTop: 2 }}>✦</span>{item}
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            {retreat.id === 4 ? (
              <>
                ...
                <p style={{ fontSize: "0.92rem", color: theme.stone, lineHeight: 1.8, marginBottom: 28 }}>
                  Nights 1 and 2 are spent in Oaxaca City — centrally located and surrounded by the city's rich colonial culture and cuisine. On Day 3, a private van takes you up to San José del Pacífico, where you'll spend three nights in cozy private mountain cabanas perched at 8,200 feet with breathtaking views of the Sierra Sur. On Day 6 you return to Oaxaca City for a farewell dinner before departure.
                </p>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
                  <div style={{ background: theme.white, padding: "28px", borderTop: `3px solid ${theme.olive}` }}>
                    <h4 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.2rem", marginBottom: 8, color: theme.charcoal }}>Oaxaca City — Nights 1, 2 & 6</h4>
                    <p style={{ fontSize: "0.85rem", color: theme.stone, lineHeight: 1.7, marginBottom: 12 }}>Comfortable, centrally located accommodation in the heart of Oaxaca City — close to markets, restaurants, and colonial landmarks.</p>
                    <p style={{ fontSize: "0.82rem", color: theme.olive, fontStyle: "italic" }}>Included — all-inclusive</p>
                  </div>
                  <div style={{ background: theme.white, padding: "28px", borderTop: `3px solid ${theme.accent}` }}>
                    <h4 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.2rem", marginBottom: 8, color: theme.charcoal }}>Sierra Sur Cabanas — Nights 3, 4 & 5</h4>
                    <p style={{ fontSize: "0.85rem", color: theme.stone, lineHeight: 1.7, marginBottom: 12 }}>Cozy private cabanas in San José del Pacífico with amazing panoramic mountain views, surrounded by ancient pine forest at 8,200 ft elevation.</p>
                    <p style={{ fontSize: "0.82rem", color: theme.olive, fontStyle: "italic" }}>Included — all-inclusive</p>
                  </div>
                </div>
...
function BookingPage() {
  ...
  const handlePayment = () => {
    ...
    let url;
    if (form.payment === "full") url = links.full;
    else if (form.payment === "couples") url = links.couples || links.full;
    else url = links.deposit;
        ...
        {step === 1 && (
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 40 }}>
              {retreats.filter(r => !r.comingSoon).map(r => (
          ...
          return (
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 28 }}>
                {[
                  ["full", `Pay in Full — $${total.toLocaleString()}`],
                  ["deposit", `Pay Deposit — $${dep.toLocaleString()} (balance due 30 days before)`],
                  ...(r.id === 4 && r.couplePrice ? [["couples", `Couples — ${r.couplePrice} (2 guests, save $800)`]] : []),
                ].map(([val, label]) => (
      ...
      <section style={{ background: theme.cream, padding: "80px 24px" }}>
        <div className="container" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 32, marginBottom: 72 }}>
            {[["100+","Guests transformed"], ["3","Retreat locations"], ["8","Max group size"], ["9","Years hosting"]].map(([n,l]) => (
