            ...
            {retreat.id === 4 ? (
              <>
                ...
                <p style={{ fontSize: "0.92rem", color: theme.stone, lineHeight: 1.8, marginBottom: 28 }}>
                  Night 1 is spent in Oaxaca City. On the morning of Day 2, a private van takes you up to San José del Pacífico — a scenic 3-hour journey into the Sierra Sur mountains — where you'll spend four nights in cozy private cabanas perched at 8,200 feet. On Day 6 you return to Oaxaca City for a farewell dinner before departure the next morning.
                </p>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
                  <div style={{ background: theme.white, padding: "28px", borderTop: `3px solid ${theme.olive}` }}>
                    <h4 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.2rem", marginBottom: 8, color: theme.charcoal }}>Oaxaca City — Nights 1 & 6</h4>
                  ...
                  <div style={{ background: theme.white, padding: "28px", borderTop: `3px solid ${theme.accent}` }}>
                    <h4 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.2rem", marginBottom: 8, color: theme.charcoal }}>Sierra Sur Cabanas — Nights 2, 3, 4 & 5</h4>
